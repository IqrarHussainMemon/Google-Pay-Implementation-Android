...
class MainActivity : AppCompatActivity() {
    ...
    private fun handlePaymentSuccess(paymentData: PaymentData) {
        ...
        try {
            ...
            Toast.makeText(this, getString(com.example.googlepay.R.string.payments_show_name, billingName), Toast.LENGTH_LONG).show()
    ...
    private fun fetchRandomGarment() : JSONObject {
        if (!::garmentList.isInitialized) {
            ...
            garmentList = Json.readFromResources(this, com.example.googlepay.R.raw.tshirts)
        }
